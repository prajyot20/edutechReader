...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	public boolean copySelection() {
		...
		if (currentApiVersion >= Build.VERSION_CODES.HONEYCOMB) {
			...
			MuPDFActivity.copiedWord = String.valueOf(text);
		} else {
		...
		if(MuPDFActivity.copySelectionFlag.equals("dict")){
			...
			intent.putExtra(SearchManager.QUERY, MuPDFActivity.copiedWord);
			if (isIntentAvailable(mContext, intent)) // check if intent is available ?
				mContext.startActivity(intent);
			else {
				showDialogMessage(mContext,"Search Confirmation","Dictionary app not install..\n ","Install Dic App", "Google search");
			}
		}
		else if(MuPDFActivity.copySelectionFlag.equals("wiki")){
			s = "https://en.wikipedia.org/wiki/" + MuPDFActivity.copiedWord;
			Intent intent = new Intent(new Intent(mContext,WebViewActivityUrlLoad.class).putExtra("url",s.toString()));
			mContext.startActivity(intent);

		}
		else if(MuPDFActivity.copySelectionFlag.equals("translate")) {

			AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
			builder.setTitle("Slect Language");
			builder.setMessage("Please select the language to convert");

			builder.setPositiveButton("Hindi",
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							Intent intent = new Intent(new Intent(mContext, WebViewActivityUrlLoad.class).putExtra("url",
									"https://www.google.co.in/search?q=translate" + MuPDFActivity.copiedWord + " to hindi"));
							mContext.startActivity(intent);
						}
					});

			builder.setNegativeButton("Marathi",
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							...
							Intent intent = new Intent(new Intent(mContext, WebViewActivityUrlLoad.class).putExtra("url",
									"https://www.google.co.in/search?q=translate" + MuPDFActivity.copiedWord + " to Marathi"));
							mContext.startActivity(intent);

						}
					});
			builder.setNeutralButton("Other Langauge",
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							// negative button logic
							Intent intent = new Intent(new Intent(mContext, WebViewActivityUrlLoad.class).putExtra("url",
									"https://www.google.co.in/search?q=translate" + MuPDFActivity.copiedWord ));
							mContext.startActivity(intent);
						}
					});
	...
	private void showDialogMessage(Context context,String title,String message,String positiveText,
								   String negativeText ) {
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Intent goToMarket = new Intent(Intent.ACTION_VIEW)
								.setData(Uri.parse("market://details?id=livio.pack.lang.en_US"));
		...
		builder.setNegativeButton(negativeText,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Intent intent = new Intent(new Intent(mContext,WebViewActivityUrlLoad.class).putExtra("url",
								"https://www.google.com/search?q=" + MuPDFActivity.copiedWord ));
						mContext.startActivity(intent);
					}
				});
